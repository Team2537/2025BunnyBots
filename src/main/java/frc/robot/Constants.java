...
public final class Constants {
  ...
  public static final class ShooterConstants {
    ...
    public static final int SHOOTER_MOTOR_TOP_ID = 17;
    public static final int SHOOTER_MOTOR_BOTTOM_ID = 18;

    public static final boolean LOADING_INVERTED = false;
    public static final boolean SHOOTER_TOP_INVERTED = false;
    public static final boolean SHOOTER_BOTTOM_INVERTED = true; // Usually one is inverted
