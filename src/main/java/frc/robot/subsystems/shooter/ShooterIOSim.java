...
public class ShooterIOSim implements ShooterIO {
        ...
        public void updateInputs(ShooterIOInputs inputs) {
                ...
                inputs.loadingVelocityRpm = loadingSim.getAngularVelocityRadPerSec() * 60.0 / (2.0 * Math.PI);
                ...
                inputs.shooterTopVelocityRpm = shooterTopSim.getAngularVelocityRadPerSec() * 60.0 / (2.0 * Math.PI);
                ...
                inputs.shooterBottomVelocityRpm = shooterBottomSim.getAngularVelocityRadPerSec() * 60.0
                                / (2.0 * Math.PI);
